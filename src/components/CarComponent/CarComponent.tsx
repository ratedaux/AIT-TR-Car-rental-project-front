        ...
        <div className="flex flex-col w-auto ">
          ...
          <div className="flex flex-col gap-3 w-auto p-3 bg-white  rounded-lg rounded-br-lg">
            ...
            <div className="flex gap-4">
              ...
              <div className="w-3/4">{dayRentalPrice} €</div>
            </div>
          </div>
        </div>
